...
let generatePassword = function () {
  ...
  if (characterAmount >= 8 && characterAmount < 129) {
    ...
    const getInteger = window.confirm("Would you like to include NUMBERS? OK = YES, Cancel = NO");
    ...
    const getSpecialCharacters = window.confirm("Would you like to include SPECIAL characters? OK = YES, Cancel = NO");
    ...
    const getLowerCase = window.confirm("Would you like to include LOWERCASE characters? OK = YES, Cancel = NO");
    ...
    const getUpperCase = window.confirm("Would you like to include UPPERCASE characters? OK = YES, Cancel = NO");
  ...
  // if user's response is invalid
    ...
    // alert user
    window.alert("Provide a valid length!");
